...
<div id="container2"> 
<div id="imgcontainer">
<center><p id="coolp">You wanna register? Here you go:</p></center>

<center><form action="rsc/reg.php" method="post">

<input name="user" type="text" id="user" size="20" placeholder="Username"><br>
<input name="pass" type="password" id="pass" size="20" placeholder="Password"><br>
<input name="avatar" type="password" id="pass" size="20" placeholder="Avatar"><br>
